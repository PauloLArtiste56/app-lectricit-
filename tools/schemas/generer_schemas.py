...
for nom, titre_s, ini, points, col in RESUMES_H:
    carte_resume(nom, titre_s, ini, points, col)
RESUMES_I = [
 ("specificites_erp", "Tertiaire et ERP", "ERP", [("Code du travail + règlement ERP", "en plus de la NF C 15-100"), ("TGBT, coupure générale, sélectivité", "un défaut = une zone"), ("BAES obligatoires", "test mensuel, vérif annuelle"), ("Locaux techniques fermés", "habilités seulement")], BLEU),
 ("verifications_periodiques", "Vérifications périodiques", "1/an", [("Organisme accrédité", "initiale puis annuelle"), ("Rapport de non-conformités", "à corriger, inspection du travail"), ("BAES, SSI", "aussi contrôlés"), ("Registre de sécurité", "tout est consigné")], VERT),
 ("chantiers_tertiaire", "Bâtiment occupé", "PP", [("Plan de prévention", "permis de feu si points chauds"), ("Coupures annoncées", "secours des postes critiques"), ("Chargé d'exploitation électrique", "autorisations, documents"), ("Balisage", "le public ne connaît pas les risques")], AMBRE),
 ("armoire", "L'armoire industrielle", "KM1", [("Sectionneur cadenassable", "protections, contacteurs, variateurs"), ("Puissance 400 V", "commande 24 V"), ("Q1, F1, KM1, fils numérotés", "le schéma est le guide"), ("Arrêt d'urgence", "portes, IP, ventilation")], BLEU),
 ("automate", "L'automate", "PLC", [("Entrées → programme → sorties", "remplace les relais câblés"), ("TOR 24 V, analogique 4-20 mA", "0-10 V"), ("Ladder, IHM", "proche des schémas à relais"), ("Sécurité machine dédiée", "pas par le programme standard")], VERT),
 ("capteurs", "Capteurs et actionneurs", "PNP", [("Inductif, capacitif, photo, ultrasons", "tout-ou-rien"), ("3 fils : +, −, signal", "PNP ou NPN"), ("Pt100, 4-20 mA", "analogique, fil coupé détecté"), ("Retour d'information", "confirme l'action")], AMBRE),
 ("principe_variateur", "Le variateur", "Hz", [("Redresseur, bus DC, onduleur", "fréquence et tension variables"), ("Démarrage progressif", "économies pompes et ventilateurs"), ("Fréquences, rampes, courant moteur", "réglages de base"), ("Bus chargé après coupure", "attendre")], BLEU),
 ("harmoniques", "Les harmoniques", "THD", [("Multiples de 50 Hz", "150, 250, 350 Hz…"), ("Variateurs, découpage, LED", "courant non sinusoïdal"), ("Échauffements, courant de neutre", "déclenchements"), ("Selfs, filtres, neutre renforcé", "analyseur de réseau")], ROUGE),
 ("cem", "Compatibilité électromagnétique", "CEM", [("Câble moteur blindé, court", "blindage 360° aux deux bouts"), ("Séparer commande et puissance", "filtre CEM à l'entrée"), ("Terre en étoile, plaques de masse", "presse-étoupes CEM"), ("Capteurs qui délirent", "le câblage est suspect")], VERT),
 ("domaines", "Les domaines de tension", "kV", [("TBT ≤ 50 V", "BT 50 à 1 000 V"), ("HTA 1 à 50 kV", "distribution 20 kV"), ("HTB > 50 kV", "transport"), ("Habilitations H", "H0, H1, H2, HC, HE")], BLEU),
 ("poste_livraison", "Le poste de livraison", "20kV", [("Cellules HTA, transfo, TGBT", "20 kV → 400 V"), ("Interverrouillage", "couper et mettre à la terre avant d'ouvrir"), ("Transfo : local ventilé, rétention", "fusibles ou disjoncteur HTA"), ("EPI HT", "gants classe 2+, écran, tapis, perches")], AMBRE),
 ("risques_ht", "Risques spécifiques HT", "DMA", [("Arc à distance", "DMA 60 cm en 20 kV, DLVS 3 m"), ("Lignes et câbles enterrés", "engins, échelles, DT-DICT"), ("Consignation HT", "+ MALT et court-circuit"), ("Engin en contact", "rester dedans, pieds joints")], ROUGE),
 ("risques_enfants", "Les risques à la maison", "!", [("Doigts, bouche, prises", "câbles mordillés, chargeur au bain"), ("Peau fine et humide", "courant plus fort"), ("Seuils plus bas", "que l'adulte"), ("30 mA protège", "mais empêcher le contact d'abord")], ROUGE),
 ("prevention_enfants", "Prévenir", "✓", [("Obturateurs, cache-prises", "câbles rangés, multiprises fixées"), ("Rien près de la baignoire", "pas de téléphone en charge au bain"), ("Lampes LED ou 12 V", "blocs à interrupteur"), ("Dehors", "pylônes, lignes, fil tombé : jamais")], AMBRE),
 ("apprendre", "Apprendre en s'amusant", "4,5V", [("6 ans : pile, ampoule, interrupteur", "chemin fermé"), ("10 ans : série, parallèle, moteur, LED", "toujours en TBTS"), ("Ados : électronique, microcontrôleur", "sous 24 V"), ("Règle d'or", "on ne bricole jamais branché")], VERT),
]
for nom, titre_s, ini, points, col in RESUMES_I:
    carte_resume(nom, titre_s, ini, points, col)
RESUMES_J = [
 ("reseau_ep", "Le réseau d'éclairage public", "EP", [("Armoire, départs, candélabres", "protection en pied de mât"), ("Horloge astronomique, cellule", "télégestion"), ("Mâts = masses", "terre + différentiel, ou classe II"), ("LED", "moitié moins, gradation")], BLEU),
 ("interventions_ep", "Intervenir sur un candélabre", "!", [("Hauteur + électricité", "nacelle, BR / B1V"), ("Couper, vérifier", "sous tension à tout moment"), ("Voirie", "balisage, gilet, casque"), ("Trappe ouverte = danger public", "lampes recyclées")], ROUGE),
 ("economies_ep", "Économies et nuisances", "23h", [("Extinction ou gradation", "30 à 60 % d'économie"), ("Détection de présence", "chemins piétons"), ("2 700 à 3 000 K", "faune et confort"), ("Pas de lumière vers le ciel", "diagnostic avant rénovation")], VERT),
 ("portail", "Le portail motorisé", "EN", [("Détection d'obstacle obligatoire", "EN 12453"), ("Feu orange, coupure d'urgence", "débrayage manuel"), ("Circuit dédié 30 mA", "câble enterré vers le pilier"), ("Un enfant", "peut être gravement blessé")], AMBRE),
 ("volets", "Volets roulants", "▲▼", [("Moteur tubulaire", "fins de course haut / bas"), ("Protection thermique", "pause après plusieurs manœuvres"), ("4 fils", "montée, descente, neutre, terre"), ("Deux moteurs", "relais de séparation")], BLEU),
 ("ascenseur", "L'ascenseur", "↕", [("Ascensoristes spécialisés", "visite toutes les 6 semaines"), ("Contrôle technique", "tous les 5 ans"), ("L'électricien", "circuit dédié, sectionneur, éclairage"), ("Personne bloquée", "rester dans la cabine, appeler")], VERT),
 ("types_pompes", "Les pompes", "kW", [("Surface : 7 à 8 m", "immergée au-delà"), ("Jamais à sec", "protection manque d'eau"), ("Disjoncteur moteur", "pointe × 5 au démarrage"), ("Pressostat + vessie", "surpresseur")], BLEU),
 ("alimentation_pompe", "Alimenter une pompe", "30mA", [("Circuit dédié", "câble immersion, section selon profondeur"), ("Boîte étanche hors du regard", "jamais dans l'eau"), ("Classe I", "terre + équipotentialité"), ("Relevage", "alarme niveau haut")], VERT),
 ("arrosage", "Arrosage et bassins", "24V", [("Électrovannes 24 V", "sans danger"), ("Bassin : 12 V", "ou 230 V IP68 hors de portée"), ("Transfo au sec", "éclairage 12 V"), ("Eau de pluie", "disconnecteur, jamais avec l'eau potable")], AMBRE),
 ("principe_eolien", "Du vent à l'électricité", "m/s", [("Puissance ∝ vitesse³", "2 × vent = 8 × puissance"), ("3 m/s → 12 m/s → 25 m/s", "démarrage, nominal, arrêt"), ("2 à 6 MW à terre", "15 MW en mer"), ("Facteur de charge", "25 % terre, 40 % mer")], BLEU),
 ("petit_eolien", "Le petit éolien", "kW", [("1 à 10 kW", "mât 12 à 30 m"), ("Vent moyen ≥ 5 m/s", "étude sur un an"), ("Déclaration, Consuel, Enedis", "comme le PV"), ("Frein, drapeau, parafoudre", "terre du mât")], VERT),
 ("integration_reseau", "Intégrer l'éolien", "HTA", [("Source variable", "équilibrage, stockage, effacement"), ("Poste de livraison HTA / HTB", "codes réseau"), ("Creux de tension, fréquence", "onduleurs conformes"), ("Habilitation H", "hauteur, rotation, arc")], AMBRE),
 ("electrolyse", "Produire de l'hydrogène", "H2", [("Eau + électricité", "50 kWh pour 1 kg (33 kWh)"), ("Rendement 60 à 70 %", "bas-carbone si électricité propre"), ("Vaporeformage", "encore majoritaire, CO2"), ("350 / 700 bar ou −253 °C", "vecteur, pas source")], BLEU),
 ("pile_combustible", "La pile à combustible", "0,7V", [("H2 + O2 → électricité + eau", "sans combustion"), ("0,7 V par cellule", "stack"), ("50 à 60 % électrique", "30 à 40 % sur le cycle"), ("Bus, camions, trains", "recharge rapide, longue durée")], VERT),
 ("securite_h2", "Sécurité de l'hydrogène", "ATEX", [("4 à 75 % : inflammable", "étincelle statique suffit"), ("Flamme invisible", "monte sous les plafonds"), ("Ventilation haute, détecteurs", "matériel Ex, terre"), ("Tensions continues élevées", "précautions VE")], ROUGE),
]
for nom, titre_s, ini, points, col in RESUMES_J:
    carte_resume(nom, titre_s, ini, points, col)
RESUMES_K = [
 ("principe_centrale", "La centrale thermique", "MW", [("Chaleur → vapeur → turbine → alternateur", "quel que soit le combustible"), ("Condensation", "tour ou eau de rivière"), ("33-38 % nucléaire, 60 % cycle combiné", "le reste en chaleur"), ("20 kV → 400 kV", "transformateur élévateur")], BLEU),
 ("reacteur", "Le réacteur REP", "REP", [("Cœur : 155 bar, 300 °C", "circuit primaire"), ("Générateur de vapeur", "secondaire séparé"), ("Barres de commande, bore", "règlent la puissance"), ("Trois barrières, diesels de secours", "refroidir même à l'arrêt")], AMBRE),
 ("parc_francais", "Le parc français", "60%", [("56 réacteurs, 18 sites", "900 à 1 450 MW"), ("60 % de la production", "électricité peu carbonée"), ("Hydraulique 12 %", "éolien, solaire, gaz de pointe"), ("Visites décennales, EPR2", "formations SCN, CSQ")], VERT),
 ("principe_hydro", "De l'eau à l'électricité", "H×Q", [("P ≈ 9,81 × Q × H × η", "en kW"), ("Pelton, Francis, Kaplan", "haute, moyenne, basse chute"), ("85 à 90 %", "rendement"), ("Démarrage en minutes", "la source la plus souple")], BLEU),
 ("barrages", "Barrages et STEP", "STEP", [("Retenue : à la demande", "fil de l'eau : en continu"), ("Éclusée", "pointe"), ("STEP : pomper puis turbiner", "75 à 80 %"), ("Lâchers d'eau", "zones interdites en aval")], VERT),
 ("petite_hydro", "La petite hydraulique", "kW", [("Ruisseau, moulin", "quelques kW à centaines de kW"), ("Droit d'eau, débit réservé", "passe à poissons"), ("Régulation, ballast, batteries", "site isolé"), ("Découplage, terre, IP élevé", "local humide")], AMBRE),
 ("equilibre", "L'équilibre du réseau", "50Hz", [("Production = consommation", "à chaque instant"), ("Fréquence : l'indicateur", "baisse si déficit"), ("Réserves primaire, secondaire", "RTE"), ("Délestage automatique", "en dernier recours")], BLEU),
 ("compteur_communicant", "Compteurs et données", "TIC", [("Index chaque jour", "courbe de charge sur accord"), ("Tarifs variables", "pointe mobile"), ("Sortie TIC", "suivi en temps réel"), ("Données personnelles", "consentement")], VERT),
 ("flexibilite", "Effacement, collectif, V2G", "V2G", [("Effacement rémunéré", "agrégateurs"), ("Autoconsommation collective", "rayon de 2 km"), ("V1G pilotage, V2G restitution", "batterie du véhicule"), ("Réseau bidirectionnel", "piloté par les données")], AMBRE),
 ("preparation_tableau", "Préparer le tableau", "1", [("Lister circuits, sections, calibres", "répartir sur les différentiels"), ("Type A", "plaque, lave-linge"), ("Coffret + 20 % de réserve", "peignes, borniers, étiquettes"), ("Hors tension vérifiée", "outils isolés")], BLEU),
 ("montage", "Monter et raccorder", "2", [("Coffret, rails, borniers", "différentiel en tête de rangée"), ("Peignes phase et neutre", "alimentation 10 / 16 mm²"), ("Dénuder 10-12 mm, embouts", "serrage au couple"), ("Étiquettes, schéma", "fils en goulottes")], VERT),
 ("controle_tableau", "Contrôler avant tension", "3", [("Visuel : serrage, cuivre, peignes", "tirer sur chaque fil"), ("Continuité des terres, isolement", "hors tension"), ("Mise sous tension progressive", "un disjoncteur à la fois"), ("Différentiels : T puis contrôleur", "resserrer après quelques semaines")], AMBRE),
 ("organisation_schema", "Le schéma industriel", "KM1", [("Folios numérotés", "puissance, commande, automate, borniers"), ("Repère + folio / colonne", "contacts référencés"), ("Q, F, KM, KA, S, H, M, T, X", "repères normalisés"), ("X1:12", "borne physique")], BLEU),
 ("puissance_commande", "Puissance et commande", "24V", [("Puissance : traits épais", "Q1, KM, F, M"), ("Commande : traits fins", "T1, arrêt d'urgence, S1, S2, H"), ("De haut en bas", "bobine alimentée si branche fermée"), ("Auto-maintien", "KM1 en parallèle de S2")], VERT),
 ("depanner_schema", "Dépanner avec le schéma", "?", [("Bobine KM1 alimentée ?", "sinon, quel contact est ouvert"), ("Arrêt d'urgence, F1, capteurs", "les évidences d'abord"), ("Tension bobine, continuité hors tension", "voyants"), ("Mettre le schéma à jour", "faux = pire qu'absent")], ROUGE),
]
for nom, titre_s, ini, points, col in RESUMES_K:
    carte_resume(nom, titre_s, ini, points, col)
RESUMES_L = [
 ("pas_a_pas", "Le moteur pas à pas", "1,8°", [("200 pas par tour", "position sans capteur"), ("Driver, micropas", "bipolaire ou unipolaire"), ("Simple, précis, peu cher", "couple chute en vitesse"), ("Perte de pas, chauffe à l'arrêt", "imprimantes 3D, découpe")], BLEU),
 ("servo", "Le servomoteur", "PID", [("Codeur + asservissement", "boucle fermée"), ("Modélisme : impulsion 1 à 2 ms", "moteur, réducteur, potentiomètre"), ("Industriel : brushless, codeur, bus", "couple, dynamique"), ("Robots, machines-outils", "plus cher que le pas à pas")], VERT),
 ("brushless", "Le brushless", "BLDC", [("Ni balais ni collecteur", "aimants au rotor"), ("Commutation électronique", "capteurs Hall ou sensorless"), ("ESC en continu", "courants élevés"), ("Génère dès que l'axe tourne", "couper avant d'intervenir")], AMBRE),
 ("procedes", "Les procédés de soudure", "MMA", [("Arc 3 000 à 6 000 °C", "électrode enrobée, MIG-MAG, TIG"), ("20 à 400 A sous 20 à 40 V", "tension à vide 50 à 100 V"), ("Inverter", "léger et régulé"), ("Chantier, atelier, précision", "selon le procédé")], BLEU),
 ("risques_soudure", "Les risques", "UV", [("Tension à vide", "milieu humide, marquage S"), ("Retour de courant près de la pièce", "sinon chemin par le corps ou les machines"), ("Coup d'arc, fumées", "UV, ozone, métaux"), ("Projections, gaz", "permis de feu, bouteilles fixées")], ROUGE),
 ("alimentation_soudure", "Alimenter un poste", "32A", [("160 A MMA : 20 à 30 A appelés", "prise 32 A ou courbe D"), ("Rallonge courte, déroulée", "forte section"), ("Différentiel type A ou F", "inverter"), ("Masque, gants, tablier, coton", "aspiration")], AMBRE),
 ("phenomene", "La foudre", "kA", [("Dizaines de kA, microsecondes", "millions de volts"), ("Points hauts et conducteurs", "1 à 2 millions d'impacts par an"), ("Coup direct, tension de pas, contact", "trois façons d'être touché"), ("Incendie, destruction", "surtensions")], ROUGE),
 ("protection_batiment", "Protéger un bâtiment", "⚡", [("Paratonnerre", "pointe, descente cuivre, terre dédiée"), ("Cage maillée", "grands bâtiments"), ("Parafoudre au tableau", "les appareils"), ("Terres interconnectées", "équipotentialité")], BLEU),
 ("comportement", "Pendant l'orage", "30s", [("Bâtiment ou voiture", "fenêtres fermées"), ("Dehors : accroupi, pieds joints", "loin des arbres et pylônes"), ("Pas de bain ni de fixe", "débrancher"), ("< 30 s : s'abriter", "attendre 30 min après")], VERT),
 ("traction", "La traction électrique", "25kV", [("Caténaire ou 3e rail", "retour par les rails"), ("1 500 V DC, 25 kV 50 Hz", "locomotives bicourant"), ("TGV : 8 à 12 MW", "récupération au freinage"), ("Métro 750 V", "tramway 750 V")], BLEU),
 ("sous_stations", "Sous-stations et signalisation", "SST", [("63 / 225 kV → 25 kV", "ou redressement 1 500 V"), ("40 à 60 km en 25 kV", "10 à 15 km en 1 500 V"), ("Circuits de voie, aiguillages", "courants faibles"), ("Sécurité intrinsèque", "défaut = signal rouge")], VERT),
 ("securite_ferroviaire", "Sécurité près des voies", "3m", [("Caténaire toujours sous tension", "3 m minimum"), ("Wagon sous caténaire", "mortel"), ("3e rail accessible", "jamais sur les voies"), ("Consignation, perches", "habilitations ferroviaires")], ROUGE),
 ("batiments_agricoles", "Bâtiments agricoles", "IP55", [("Humidité, ammoniac, rongeurs", "IP55, polyester"), ("Courants vagabonds", "les animaux fuient"), ("Équipotentialité, 30 mA", "toutes les masses"), ("Ventilation, traite", "groupe de secours")], BLEU),
 ("clotures", "Clôtures et irrigation", "kV", [("5 000 à 10 000 V en impulsions", "douloureux, pas mortel en général"), ("Électrificateur homologué", "jamais le secteur, un seul"), ("Panneaux au bord des chemins", "enfants, cœurs fragiles"), ("Pompes triphasées, IP65", "foudre")], AMBRE),
